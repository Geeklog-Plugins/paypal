...
$LANG_PAYPAL_CART = array(
    ...
    'payment_card_paypal_help' => 'PayPal peut proposer le paiement par carte sans compte PayPal selon la transaction et la situation de l’acheteur.',
...
$LANG_PAYPAL_TOOLTIPS = array(
    ...
    'receiverEmailAddr' => 'Identité marchand envoyée dans le champ PayPal business. Utilisez de préférence le Merchant ID plutôt que l’e-mail afin d’éviter d’exposer l’adresse du marchand. Le nom affiché par PayPal pendant le checkout provient du profil Business PayPal ; configurez-y le nom de votre site ou de votre entreprise.',
