...
$LANG_PAYPAL_TOOLTIPS = array(
    ...
    'receiverEmailAddr' => 'Merchant identity sent as PayPal business. In Sandbox use the Merchant ID or confirmed email of the Sandbox Business account; in Live use the live merchant identity.',
