...
$LANG_PAYPAL_CART = array(
    ...
    'payment_card_paypal_help' => 'PayPal may offer card payment without requiring a PayPal account, depending on the transaction and buyer location.',
...
$LANG_PAYPAL_TOOLTIPS = array(
    ...
    'receiverEmailAddr' => 'Merchant identity sent as PayPal business. Prefer the Merchant ID instead of an email address to avoid exposing the merchant email. The business name displayed by PayPal during checkout comes from the PayPal Business profile, so configure the site or company name there.',
