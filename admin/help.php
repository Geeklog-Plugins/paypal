...
$template->set_var(array(
    ...
    'manage_categories' => $LANG_PAYPAL_1['manage_categories'],
    'manage_attributes' => $LANG_PAYPAL_1['manage_attributes'],
    'manage_attribute_types' => $LANG_PAYPAL_1['manage_attribute_types'],
    'manage_shipping' => $LANG_PAYPAL_1['manage_shipping'],
    'shipper_services' => $LANG_PAYPAL_1['shipper_services'],
    'shipping_locations' => $LANG_PAYPAL_1['shipping_locations'],
