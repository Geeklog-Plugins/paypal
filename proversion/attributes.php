...
function PAYPALPRO_attributesMenu()
{
...
function PAYPALPRO_attributes()
{
    ...
    $retval .= PAYPALPRO_listAttributes();

    return $retval;
}

function PAYPALPRO_listAttributes()
{
    ...
    return ADMIN_list(
        'paypal_attributes',
        'PAYPALPRO_getListField_paypal_attributes',
        $header,
        $text,
        $query,
...
function PAYPALPRO_getListField_paypal_attributes($fieldname, $fieldvalue, $A, $icon_arr)
{
    global $_CONF, $LANG21;
