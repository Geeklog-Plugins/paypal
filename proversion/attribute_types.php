...
function PAYPALPRO_attributeTypesMenu()
{
...
function PAYPALPRO_attributeTypes()
{
...
function PAYPAL_listAttributeTypes()
{
    ...
    return ADMIN_list(
        ...
        'PAYPALPRO_getListField_paypal_attributetypes',
        $header,
        array(
            'has_extras' => true,
...
function PAYPALPRO_getListField_paypal_attributetypes($fieldname, $fieldvalue, $A, $icon_arr)
{
    global $_CONF;
