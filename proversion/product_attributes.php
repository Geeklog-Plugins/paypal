...
function PAYPALPRO_displayAttributes($productId)
{
...
function PAYPALPRO_displayAttributesToAdd($productId)
{
    global $_CONF, $_TABLES, $LANG_PAYPAL_ADMIN, $LANG_ADMIN;
...
function PAYPALPRO_displayCustomAttributes($productId)
{
...
function PAYPALPRO_reorderAttributes()
{
    global $_TABLES;
